...
public class TotalPerMember__1 {
    ...
    public String toString() {
        ...
        sb.append(TotalPerMember__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("status");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TotalPerMember__1) == false) {
            return false;
        }
        TotalPerMember__1 rhs = ((TotalPerMember__1) other);
